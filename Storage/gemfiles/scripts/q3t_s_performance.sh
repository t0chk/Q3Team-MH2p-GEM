...
echo "Installation/deinstallation of Q3 configurable S Performance skin..."
...
if [[ ! -e "$LSD_JARS_PATH/CombiSkins.jar" ]]; then
    ...
    cp -Vf $GEM_JARS_PATH/CombiSkinsSPerfomance.jar $LSD_JARS_PATH/CombiSkins.jar
else
    echo "Disabling S Performance skin... Run script again to install back."
