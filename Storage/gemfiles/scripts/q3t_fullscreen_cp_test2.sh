...
echo "Starting of [Fast FullScreenAACPCL_test2 install From USB] script..."
...
if [[ ! -e "$LSD_JARS_PATH/FullScreenAACPCL.jar" ]]; then
	echo "Activating FullScreenAACPCL_test2 mod..."
    cp -Vf $MODPATH/Storage/jars/FullScreenAACPCL_test2.jar $LSD_JARS_PATH/FullScreenAACPCL.jar
else
